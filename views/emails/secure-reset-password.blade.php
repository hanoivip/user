...
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;color:#333333;font-size:20px;font-weight:400;text-transform:uppercase">Yêu cầu đặt lại mật khẩu</p>
</td>
</tr>
<tr>
<td height="30">
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:13px">Chào bạn,</p>
</td>
</tr>
<tr>
<td height="30">
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;color:#555;font-size:13px">Bạn vừa gửi yêu cầu đặt lại mật khẩu trên <strong>{{ config('id.name.site') }}</strong>.</p>
</td>
</tr>
<tr>
<td height="30">
...
<tr>
<td height="60">
<p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px">{{ route('pass-reset', [ 'token' => $token ])}}</p>
</td>
</tr>
<tr>
<td height="30">
