	...
	<tbody>
		...
		<tr>
			<td height="30">
				<p
					...
					Bạn đã tắt tính năng xác thực 2 bước. Tài khoản của bạn không còn được bảo vệ</strong>.
				</p>
			</td>
		</tr>
		...
		<tr>
			<td height="30">
				<p
					style="margin: 0; font-family: Arial, Helvetica, sans-serif; color: #555; font-size: 13px">
					Nếu không phải là bạn thực hiện việc này, mời liên hệ ngay fanpage để được hỗ trợ</strong>.
				</p>
			</td>
		</tr>
